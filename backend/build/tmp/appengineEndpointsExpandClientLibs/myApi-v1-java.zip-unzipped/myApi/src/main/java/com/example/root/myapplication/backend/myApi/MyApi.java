...
public class MyApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @since 1.7
   */
  public static final String DEFAULT_ROOT_URL = "https://udacitybuilditbigger-project4.appspot.com/_ah/api/";
  ...
  public class GetJoke extends MyApiRequest<com.example.root.myapplication.backend.myApi.model.MyBean> {
     ...
     */
    protected GetJoke() {
      super(MyApi.this, "GET", REST_PATH, null, com.example.root.myapplication.backend.myApi.model.MyBean.class);
    }
